...
default_record as (
    ...
    SELECT
        ...
        , '-8'      as COUNTRY_CODE -- adding comments to test slim0-ci-job v1
        , '-1'      as EXCHANGE_CODE
...
hashed as (
    ...
    SELECT
        ...
        , {{ dbt_utils.generate_surrogate_key([ 'SECURITY_CODE', 'SECURITY_NAME', 'SECTOR_NAME', 'INDUSTRY_NAME', 'COUNTRY_CODE', 'EXCHANGE_CODE'])
           }} as SECURITY_HDIFF 
